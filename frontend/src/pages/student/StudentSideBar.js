    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Student/thesis">
                    <ListItemIcon>
                        <AssignmentIcon color={location.pathname.startsWith("/Student/thesis") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                ...
                <ListItemButton component={Link} to="/Student/comment">
                    <ListItemIcon>
                        <AnnouncementOutlinedIcon color={location.pathname.startsWith("/Student/comment") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
